...
for total=1:10
   ...
   for iteration=1:20
disp(iteration)
cd('C:\Users\User\Desktop\논문\TASE\TASE_CSSBL_FINAL\TASE_CSSBL_FINAL\GSSBL\GSSBL\Sim\result_before_submit_final\Dai\ESTIMATE');       
filename = sprintf('estimate_%d_%d.csv', total,iteration );
estimate=csvread(filename);       
       
cd('C:\Users\User\Desktop\논문\TASE\TASE_CSSBL_FINAL\TASE_CSSBL_FINAL\GSSBL\GSSBL\Sim\result_before_submit_final\Dai\X');       
filename = sprintf('x_%d_%d.csv', total,iteration );
x=csvread(filename);   
       
cd('C:\Users\User\Desktop\논문\TASE\TASE_CSSBL_FINAL\TASE_CSSBL_FINAL\GSSBL\GSSBL\Sim\result_before_submit_final\Dai\R1');       
filename = sprintf('r1_%d_%d.csv', total,iteration );
r1=csvread(filename);  

cd('C:\Users\User\Desktop\논문\TASE\TASE_CSSBL_FINAL\TASE_CSSBL_FINAL\GSSBL\GSSBL\Sim\result_before_submit_final\Dai\R2');       
filename = sprintf('r2_%d_%d.csv', total,iteration );
r2=csvread(filename);  



cd('C:\Users\User\Desktop\논문\TASE\TASE_CSSBL_FINAL\TASE_CSSBL_FINAL\GSSBL\GSSBL\Sim\result_before_submit_final\Dai\Z');       
filename = sprintf('z_%d_%d.csv', total,iteration );
z=csvread(filename);  

cd('C:\Users\User\Desktop\논문\TASE\TASE_CSSBL_FINAL\TASE_CSSBL_FINAL\GSSBL\GSSBL\Sim\result_before_submit_final\Dai\GAMMA');       
filename = sprintf('variance_%d_%d.csv', total,iteration );
variance=csvread(filename);
       
cd('C:\Users\User\Desktop\논문\TASE\TASE_CSSBL_FINAL\TASE_CSSBL_FINAL\GSSBL\GSSBL\Sim\result_before_submit_final\Dai\FAULT_INDEX');       
filename = sprintf('FAULT_INDEX_%d_%d.csv', total,iteration );
fault_index=csvread(filename);

cd('C:\Users\User\Desktop\논문\TASE\TASE_CSSBL_FINAL\TASE_CSSBL_FINAL\GSSBL\GSSBL\Sim\result_before_submit_final\Dai\ITERATION')
...
label_1(2)=1;
label_1(3)=1;
label_1(fault_index(1))=1;
label_1(fault_index(3))=1;
label_1(fault_index(5))=1;

label_2=zeros(N,1);
label_2(4)=1;
label_2(5)=1;
label_2(6)=1;
label_2(fault_index(2))=1;
label_2(fault_index(4))=1;
label_2(fault_index(6))=1;
...
var_1(2)=1;
var_1(3)=1;
var_1(fault_index(1))=1;
var_1(fault_index(3))=1;
var_1(fault_index(5))=1;

var_2=ones(N,1)*0.01;
var_2(4)=1;
var_2(5)=1;
var_2(6)=1;
var_2(fault_index(2))=1;
var_2(fault_index(4))=1;
var_2(fault_index(6))=1;
