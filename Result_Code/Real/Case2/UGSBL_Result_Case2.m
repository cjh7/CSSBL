...
for total=1:10
   ...
   for iteration=1:20
disp(iteration)
cd('C:\Users\User\Desktop\새 폴더\Code\Result\Real\Case2\UGSBL\ESTIMATE');       
filename = sprintf('estimate_%d_%d.csv', total,iteration );
estimate=csvread(filename);       
       
cd('C:\Users\User\Desktop\새 폴더\Code\Result\Real\Case2\UGSBL\X');       
filename = sprintf('x_%d_%d.csv', total,iteration );
x=csvread(filename);   
       
cd('C:\Users\User\Desktop\새 폴더\Code\Result\Real\Case2\UGSBL\GAMMA');       
...
cd('C:\Users\User\Desktop\새 폴더\Code\Result\Real\Case2\UGSBL\Z');       
filename = sprintf('z_%d_%d.csv', total,iteration );
z=csvread(filename);  


cd('C:\Users\User\Desktop\새 폴더\Code\Result\Real\Case2\UGSBL\FAULT_INDEX');       
filename = sprintf('FAULT_INDEX_%d_%d.csv', total,iteration );
fault_index=csvread(filename);


cd('C:\Users\User\Desktop\새 폴더\Code\Result\Real\Case2\UGSBL\ITERATION')
