...
for total=1:5
   ...
   for iteration=1:20
disp(iteration)
cd('C:\Users\User\Desktop\새 폴더\Code\Result\Real\Case1\SSBL\ESTIMATE');       
filename = sprintf('estimate_%d_%d.csv', total,iteration );
estimate=csvread(filename);       
       
cd('C:\Users\User\Desktop\새 폴더\Code\Result\Real\Case1\SSBL\X');       
...
cd('C:\Users\User\Desktop\새 폴더\Code\Result\Real\Case1\SSBL\Z');       
filename = sprintf('z_%d_%d.csv', total,iteration );
z=csvread(filename);  


cd('C:\Users\User\Desktop\새 폴더\Code\Result\Real\Case1\SSBL\GAMMA');       
filename = sprintf('variance_%d_%d.csv', total,iteration );
variance=csvread(filename);
       
cd('C:\Users\User\Desktop\새 폴더\Code\Result\Real\Case1\SSBL\FAULT_INDEX');       
filename = sprintf('FAULT_INDEX_%d_%d.csv', total,iteration );
fault_index=csvread(filename);


cd('C:\Users\User\Desktop\새 폴더\Code\Result\Real\Case1\SSBL\ITERATION')
