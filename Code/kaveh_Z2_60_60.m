...
warning('off','all')
rng(100);
% cd('C:\Users\jihoon7\Desktop\gssbl_new\sim\KAVEH\Result_Z2_60_60_modify_80_3');
for total=6:6
...
% 
% lambda = norm(resid(:), 'fro')^2/(M*L) + (lambda *(N*L-trace( covariance_all(:,:,1)*Sigma(:,:,1))))/(M*L);
% lambda=1/lambda;
...
cd('C:\Users\User\Desktop\논문\TASE\TASE_CSSBL_FINAL\TASE_CSSBL_FINAL\GSSBL\GSSBL\Sim\result_before_submit_final\KAVEH\X');
filename = sprintf('x_%d_%d.csv', total,iteration );
csvwrite(filename,x);
cd('C:\Users\User\Desktop\논문\TASE\TASE_CSSBL_FINAL\TASE_CSSBL_FINAL\GSSBL\GSSBL\Sim\result_before_submit_final\KAVEH\ESTIMATE');
filename = sprintf('estimate_%d_%d.csv', total,iteration );
csvwrite(filename,estimate);

cd('C:\Users\User\Desktop\논문\TASE\TASE_CSSBL_FINAL\TASE_CSSBL_FINAL\GSSBL\GSSBL\Sim\result_before_submit_final\KAVEH\ITERATION');
filename = sprintf('iteration_%d_%d.csv', total,iteration );
csvwrite(filename,i1);
cd('C:\Users\User\Desktop\논문\TASE\TASE_CSSBL_FINAL\TASE_CSSBL_FINAL\GSSBL\GSSBL\Sim\result_before_submit_final\KAVEH\GAMMA');
filename = sprintf('variance_%d_%d.csv', total,iteration );
variance_interest=1./gamma;
csvwrite(filename,variance_interest);

cd('C:\Users\User\Desktop\논문\TASE\TASE_CSSBL_FINAL\TASE_CSSBL_FINAL\GSSBL\GSSBL\Sim\result_before_submit_final\KAVEH\R1');
filename = sprintf('r1_%d_%d.csv', total,iteration );
csvwrite(filename,sort(r(1:L1)));

cd('C:\Users\User\Desktop\논문\TASE\TASE_CSSBL_FINAL\TASE_CSSBL_FINAL\GSSBL\GSSBL\Sim\result_before_submit_final\KAVEH\R2');
filename = sprintf('r2_%d_%d.csv', total,iteration );
csvwrite(filename,sort(r(L1+1:L)));

cd('C:\Users\User\Desktop\논문\TASE\TASE_CSSBL_FINAL\TASE_CSSBL_FINAL\GSSBL\GSSBL\Sim\result_before_submit_final\KAVEH\B1');
filename = sprintf('B1_%d_%d.csv', total,iteration );
csvwrite(filename, inv(B1));

cd('C:\Users\User\Desktop\논문\TASE\TASE_CSSBL_FINAL\TASE_CSSBL_FINAL\GSSBL\GSSBL\Sim\result_before_submit_final\KAVEH\B2');
filename = sprintf('B2_%d_%d.csv', total,iteration );
csvwrite(filename, inv(B2));


cd('C:\Users\User\Desktop\논문\TASE\TASE_CSSBL_FINAL\TASE_CSSBL_FINAL\GSSBL\GSSBL\Sim\result_before_submit_final\KAVEH\FAULT_INDEX');
