...
cd('C:\Users\User\Desktop\새 폴더\Code\Method\Real\Case2')
...
cd('C:\Users\User\Desktop\새 폴더\Code\Result\Real\Case2\MSBL\X');
filename = sprintf('x_%d_%d.csv', total,iteration );
csvwrite(filename,x);
cd('C:\Users\User\Desktop\새 폴더\Code\Result\Real\Case2\MSBL\ESTIMATE');
filename = sprintf('estimate_%d_%d.csv', total,iteration );
csvwrite(filename,Weight_MSBL);

cd('C:\Users\User\Desktop\새 폴더\Code\Result\Real\Case2\MSBL\ITERATION');
filename = sprintf('iteration_%d_%d.csv', total,iteration );
csvwrite(filename,count);
cd('C:\Users\User\Desktop\새 폴더\Code\Result\Real\Case2\MSBL\GAMMA');
filename = sprintf('variance_%d_%d.csv', total,iteration );
variance_interest=gamma;
csvwrite(filename,variance_interest);


cd('C:\Users\User\Desktop\새 폴더\Code\Result\Real\Case2\MSBL\FAULT_INDEX');
...
cd('C:\Users\User\Desktop\새 폴더\Code\Result\Real\Case2\LEE\X');
filename = sprintf('x_%d_%d.csv', total,iteration );
csvwrite(filename,x);
cd('C:\Users\User\Desktop\새 폴더\Code\Result\Real\Case2\LEE\ESTIMATE');
filename = sprintf('estimate_%d_%d.csv', total,iteration );
csvwrite(filename,Weight_LEE);


cd('C:\Users\User\Desktop\새 폴더\Code\Result\Real\Case2\LEE\GAMMA');
filename = sprintf('variance_%d_%d.csv', total,iteration );
variance_interest=est_sig2a;
csvwrite(filename,variance_interest);

cd('C:\Users\User\Desktop\새 폴더\Code\Result\Real\Case2\LEE\FAULT_INDEX');
filename = sprintf('FAULT_INDEX_%d_%d.csv', total,iteration );
csvwrite(filename,fault_ind);    
